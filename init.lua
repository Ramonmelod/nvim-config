...
vim.api.nvim_set_keymap("n", "<leader>k", ":ToggleTerm 0 size=40 direction=vertical<CR>", { noremap = true, silent = true}) -- it opens the vert. terminal number 0
vim.api.nvim_set_keymap("n", "<leader>1", ":ToggleTerm 1 size=40 direction=vertical<CR>", { noremap = true, silent = true}) -- it opens the vert. terminal number 1
vim.api.nvim_set_keymap("n", "<leader>2", ":ToggleTerm 2 size=40 direction=vertical<CR>", { noremap = true, silent = true}) -- it opens the vert. terminal number 2
vim.api.nvim_set_keymap("n", "<leader>3", ":ToggleTerm 3 size=40 direction=vertical<CR>", { noremap = true, silent = true}) -- it opens the vert. terminal number 3
vim.api.nvim_set_keymap("n", "<leader>4", ":ToggleTerm 4 size=40 direction=vertical<CR>", { noremap = true, silent = true}) -- it opens the vert. terminal number 4
vim.api.nvim_set_keymap("n", "<leader>5", ":ToggleTerm 5 size=40 direction=vertical<CR>", { noremap = true, silent = true}) -- it opens the vert. terminal number 5
vim.api.nvim_set_keymap("n", "<leader>6", ":ToggleTerm 6 size=40 direction=vertical<CR>", { noremap = true, silent = true}) -- it opens the vert. terminal number 6
